...
/**
 * Useful for determining the host CPU architecture.
 * see [os.arch](https://nodejs.org/api/os.html#os_os_arch)
 *
 * @return      the CPU architecture of the operating system
 */
