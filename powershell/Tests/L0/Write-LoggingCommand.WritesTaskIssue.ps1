...
Invoke-VstsTaskScript -ScriptBlock {
    ...
    Assert-AreEqual $expected $actual "The default 'TastInternal' source was added for errors."
    ...
    Assert-AreEqual $expected $actual "The default 'TastInternal' source was added for warnings."
    ...
    Assert-AreEqual $expected $actual "Adds the specified issue source for errors."
    ...
    Assert-AreEqual $expected $actual "Adds the specified issue source for warnings."
}